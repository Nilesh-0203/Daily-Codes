...
<strong>Explanation: </strong>5057 is the only number that does
...
<strong>Explanation: </strong>Since there is no number that
does not contain a 9,output is -1.</span></pre>
